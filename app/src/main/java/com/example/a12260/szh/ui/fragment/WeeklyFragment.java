...
public class WeeklyFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        map = GreenDaoUtils.getInstance().listDailyRecordsInWeek(start);
        init();
        return view;
    }
...
//            System.out.println("长度不一样，先停了");
        ...
        Listener listener = new Listener(start, days, packNames, times);
    ...
    class Listener implements PieChartOnValueSelectListener {
        ...
        public Listener(Long startTime, List<String> strings, long[] longs) {
