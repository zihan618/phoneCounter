...
public class MainStatisticsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Toolbar toolbar = view.findViewById(R.id.statistic_toolbar);
        toolbar.inflateMenu(R.menu.menu_statistics);
        toolbar.setOnMenuItemClickListener(x -> {
            if (x.getItemId() == R.id.item_daily) {
                ...
                transaction.add(R.id.statistic_container, dailyFragment, getString(R.string.daily));
                transaction.commit();
                ...
                FragmentTransaction transaction = getChildFragmentManager().beginTransaction();
                transaction.add(R.id.statistic_container, weeklyFragment, getString(R.string.weekly));
                transaction.commit();
                ...
                transaction2.add(R.id.statistic_container, monthlyFragment, getString(R.string.monthly));
                transaction2.commit();
